...
vImovelLista = ["casas-de-vila"]   #"casas","casas-de-vila","casas-de-condominio"
vCidadeLista = ["rio-de-janeiro"] #Coloca o estado no formato "rio-de-janeiro","sao-paulo", ou "TODOS" sendo que tem q ajustar a vUF para pegar o estado
vZonaLista = ["zona-oeste"] #"zona-norte","centro","zona-sul", "zona-oeste", "zona-leste", "TODOS", etc
...
vValorMin = 300000      #Valor Minimo
vValorMax = 520000     #Valor Maximo
                ...
                if vBairro == 'TODOS':
                    if vZona == 'TODOS':
                        if vCidade == 'TODOS':
                            ...
                            vURL_B = "https://www.zapimoveis.com.br/" + vTransacao + "/" + vImovel + "/" + vUF + "+" + vCidade + "/" + str(vQuartos) + "-Quartos"
                    else:
